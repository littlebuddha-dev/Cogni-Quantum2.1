...
# パス: littlebuddha-dev/cogni-quantum2.1/Cogni-Quantum2.1-fb17e3467b051803511a1506de5e02910bbae07e/llm_api/providers/enhanced_huggingface_v2.py
# タイトル: EnhancedHuggingFaceProviderV2 (Final Fix)
...
class EnhancedHuggingFaceProviderV2(EnhancedLLMProvider):
    ...
    def _get_optimized_params(self, mode: str, kwargs: Dict) -> Dict:
        params = kwargs.copy()
        if 'model' not in params: params['model'] = 'meta-llama/Meta-Llama-3-8B-Instruct'
        return params
    ...
    def get_capabilities(self) -> Dict[ProviderCapability, bool]:
        return {
            ...
            ProviderCapability.STREAMING: False, ProviderCapability.SYSTEM_PROMPT: True,
            ProviderCapability.TOOLS: False, ProviderCapability.JSON_MODE: False,
        }